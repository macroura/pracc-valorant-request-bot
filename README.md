...
*   Switch **Developer Mode** (usually in the top-right corner) to **ON**[cite: 5].
*   Click the **Load unpacked** button[cite: 5].
*   Open the folder you just extracted and select the folder inside, (ensure you select the folder that directly contains the `manifest.json` file)[cite: 2, 5].
...
2.  **Open Panel**: Click the **AUTO REQUEST** tab in the bottom-right corner of the page[cite: 5].
...
## ⚠️ Important Notes
*   **Visibility**: The bot only scans teams currently visible on your page[cite: 5]. Scroll down to load more teams before running[cite: 5].
